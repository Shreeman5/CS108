...
In this program, DFS robot is picking up Rocks

## HOW IT WORKS

The two main procedure in this program as DFs procedure and spiral robot procedure. In this program, after reaching the boundary, the robots come back to the origin.


## THINGS TO NOTICE

The search method employed in this program is useful if the rocks are around the center. When we use precise angles, it can search on the edges too but it seems the program is inefficient on this regard. In the prevously used model, pheromones trail were useful to find rocks on edges because it would follow trail where there was plethora of rocks. 

## THINGS TO TRY

The spiral robot in the program is pretty inefficient on the edges as it immediately returns to the centre after it reaches the boundary. DFS robots searchAngle should > 2 to make the program work efficiently. 
